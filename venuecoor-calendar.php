...
<header>
        <ul class="left-nav">
            ...
            <li class="sidebar"><a href="venuecoor-venues.php"><i class="ri-map-pin-line"></i> Venues</a></li>
            <li class="sidebar"><a href="venuecoor-calendar.php" class="active"><i class="ri-calendar-line"></i> Calendar</a></li>
            <!-- Logout Button -->
