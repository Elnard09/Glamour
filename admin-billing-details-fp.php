            ...
            <table class="table-records" style="color: #fff;">
                ...
                <div id="myModals" class="modals" style="position: fixed; z-index: 1000; left: 0; top: 0; width: 100%; height: 100%; backdrop-filter: blur(10px);">
                            <div class="modal-content" style="background: #383838; width: 50%;  border-radius: 20px;">
                                <h1 style="font-family: Judson; color: var(--main-color); font-size: 2em;">FULL PAYMENT BILLING DETAILS</h1>
                                ...
                                <div class="grid-container">
                                    ...
                                    <div class="column2">
                                        ...
                                        <p style="height: 30px; padding: 5px 15px;">PHP <?= $billrow['fppayment']; ?></p>
                                    </div>
                                </div>
                                <div class="column-container">
                                    <div class="column-item">
                                ...
                                <div class="button-container">
                                    ...
                                    <a href="fpapprove.php?fpapproveid=<?= $billrow['id']; ?>&billing=<?= $billrow['billing_id']; ?>"><button class="approve-button">APPROVE</button></a>
                                    <a href="fpdecline.php?fpdeclineid=<?= $billrow['id']; ?>&billing=<?= $billrow['billing_id']; ?>&amount=<?= $billrow['amount']; ?>"><button class="decline-button">DECLINE</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
