...
<header>
        <ul class="left-nav">
            ...
            <li class="profile-section">
                ...
                <p>Style & Creation Coordinator</p>
            </li>
            <!-- Left Nav Bar -->
            <li class="sidebar"><a href="stylecoor-list.php" ><i class="ri-file-list-line"></i> Style Book List</a></li>
            <li class="sidebar"><a href="stylecoor-calendar.php" class="active"><i class="ri-calendar-line"></i> Calendar</a></li>
            <!-- Logout Button -->
