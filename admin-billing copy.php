                     ...
                     <!------modal for downpayment ------->
                        <div id="myModal" class="modal">
                            <div class="modal-content" style="background: #383838; width: 50%;  border-radius: 20px;">
                                <h1 style="font-family: Poppins; color: var(--main-color); font-size: 2em;">DOWN PAYMENT BILLING DETAILS</h1>
                                ...
                                <div class="grid-container">
                                    ...
                                    <div class="column2">
                                        ...
                                        <p style="height: 30px; padding: 5px 15px;">PHP <?= $row['amount']; ?></p>
                                    </div>
                                </div>
                                <div class="column-container">
                                    <div class="column-item">
            ...
            <table class="table-records" style="color: #fff;" id="fullpaymenttable">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: center;"><?= $row['status']; ?></td>
                        <td style="text-align: center;">
                            <button class="view-btn" id="viewbtn" onclick="openPopup(<?= $row['billing_id']; ?>)"><i class="ri-eye-line"></i></button>
                            <a href=""><button class="delete-btn"><i class="ri-delete-bin-line"></i></button></a>
                        </td>
                    </tr>
                </tbody>
