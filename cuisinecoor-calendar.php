...
<head>
    ...
    <title>Calendar | Coordinator</title>
...
<header>
        <ul class="left-nav">
            ...
            <!-- Left Nav Bar -->
            <li class="sidebar"><a href="cuisinecoor-list.php"><i class="ri-file-list-line"></i> Catering Book List</a></li>
            <li class="sidebar"><a href="cuisinecoor-calendar.php" class="active"><i class="ri-calendar-line"></i> Calendar</a></li>
            <!-- Logout Button -->
