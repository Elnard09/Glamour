...
<header>
        <ul class="left-nav">
            ...
            <li class="profile-section">
                ...
                <p>Services Coordinator</p>
            </li>
            <!-- Left Nav Bar -->
            <li class="sidebar"><a href="extracoor-list.php" ><i class="ri-file-list-line"></i> Services Book List</a></li>
            <li class="sidebar"><a href="extracoor-calendar.php" class="active"><i class="ri-calendar-line"></i> Calendar</a></li>
            <!-- Logout Button -->
