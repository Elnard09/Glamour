...
session_start();
    ...
    //show pending
    $sql = "SELECT * FROM booking WHERE coordinator_1 = 'Pending' ORDER BY id DESC ";
    $bookingresult = mysqli_query($connection, $sql);

    //show approved
    $sql1 = "SELECT * FROM booking WHERE coordinator_1 = 'Approved' ";
    $bookingresult1 = mysqli_query($connection, $sql1);

    //show disapproved
    $sql2 = "SELECT * FROM booking WHERE coordinator_1 = 'Declined' ";
...
<head>
    ...
    <title>Venue Book List | Coordinator</title>
...
<body style="background: var(--bg-color);">
    ...
    <header>
        <ul class="left-nav">
            ...
            <li class="profile-section">
                ...
                <p style="color: #fff;">Venue Coordinator</p>
            </li>
            <!-- Left Nav Bar -->
            <li class="sidebar"><a href="venuecoor-list.php" style="text-decoration: none;" class="active"><i class="ri-file-list-line"></i> Venue Book List</a></li>
            <li class="sidebar"><a href="venuecoor-venues.php" style="text-decoration: none;" ><i class="ri-map-pin-line"></i> Venues</a></li>
            <li class="sidebar"><a href="venuecoor-calendar.php" style="text-decoration: none;"><i class="ri-calendar-line"></i> Calendar</a></li>
            <!-- Logout Button -->
    ...
    <main style="color: #fff; font-size: .8em;">
        ...
        <div class="container-adminlist" style="color: #fff;">
            <h3 style="font-size: 1.25em; font-weight: bolder;">Pending Venue Bookings</h3>
        ...
        if(mysqli_num_rows($birthresult)>0 && $rows['venue'] != $none){
            $venue = $rows['venue'];
        ...
        $corporateresult = mysqli_query($connection, $showcorporate);
                ...
                continue;
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="venueapprove.php? approveid='.$id.' & booking='.$booking_id.' "><button class="confirm-btn" name="reset_link" id="reset_link" onclick="return confirm(\'Are you sure you want to perform this action? This cannot be undone.\')"><i class="ri-check-line"></i></button></a>
                                        <a href="venuedisapprove.php? disapproveid='.$id.' & booking='.$booking_id.' "><button class="delete-btn" name="reset_link" id="reset_link" onclick="return confirm(\'Are you sure you want to perform this action? This cannot be undone.\')"><i class="ri-close-line"></i></button></a>
                                    </td>
                                </tr>
                                    ';
                            }
            ...
            <h3 style="font-size: 1.25em; font-weight: bolder; margin-top: 30px;">Accepted Venue Bookings</h3>
            <table class="table-records" style="color: #fff;">
                <thead style="font-size: 1em; ">
                    <tr>
                        <th style="text-align: center;">Booking ID</th>
        ...
        $corporateresult = mysqli_query($connection, $showcorporate);
            if(mysqli_num_rows($corporateresult)>0){
                ...
                $guest_number = $rows['guest_number'];
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;"> '.$bookdate.' </td>
                                    <td style="text-align: center;">
                                        <a href="venuedelete.php? deleteid='.$id.' & booking='.$booking_id.' "><button class="delete-btn" name="reset_link" id="reset_link" onclick="return confirm(\'Are you sure you want to delete?\')"><i class="ri-delete-bin-line"></i></button></a>
                                    </td>
                                </tr>
                                    ';
                            }
            ...
            <h3 style="font-size: 1.25em; font-weight: bolder; margin-top: 30px;">Declined Venue Bookings</h3>
            <table class="table-records" style="color: #fff;">
                <thead style="font-size: 1em; ">
                    <tr>
                        <th style="text-align: center;">Booking ID</th>
