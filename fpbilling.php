...
session_start();
    ...
    if(isset($_POST['submit1']))
    {
        ...
        valid_id='$validIDData', proof='$proofData', fppayment='$fppayment', date='$downdate', mop='$cash', 
        payment_type='Fullpayment', fpstatus='Pending' WHERE booking_id='$booking_id' ";
    ...
    if(isset($_POST['submit2']))
    {
        ...
        $update = "UPDATE billing SET firstname='$firstname', lastname='$lastname', address='$address',  email='$email', phone='$contact', ref_num='$ref', valid_id='$validIDData', proof='$proofData', fppayment='$fppayment', date='$downdate', mop='$bank', payment_type='Fullpayment', fpstatus='Pending' WHERE booking_id='$booking_id' ";
        $sqlupdate = mysqli_query($connection, $update);
    ...
    if(isset($_POST['submit3']))
    {
        ...
        $update = "UPDATE billing SET firstname='$firstname', lastname='$lastname', address='$address',  email='$email', phone='$contact', valid_id='$validIDData', proof='$proofData', fppayment='$fppayment', date='$downdate', mop='$paypal', payment_type='Fullpayment', fpstatus='Pending' WHERE booking_id='$booking_id' ";
        $sqlupdate = mysqli_query($connection, $update);
...
<head>
    ...
    <title>Full Payment Billing Form | Glamour</title>
    ...
    <section class="billing" id="billing">
        ...
        <h3 style="color: #D2D2D2; margin-top: 60px"><em>Please select your mode of payment</em></h3>
            ...
            <h4>Account Details</h4>
                <h5>Sender's Information</h5>
                    ...
                    <div class="grid">
                        ...
                        <div class="grid-item grid-item-2">
                            <input type="text" id="fppayment" name="fppayment" required placeholder="Enter the Payment Amount" value="<?php echo $rows['amount']/2; ?>">
            ...
            <div class="banner">
                ...
                <input type="hidden" name="description" value="Full Payment">
                ...
                <h5>Sender's Information</h5>
                    ...
                    <div class="grid">
                        ...
                        <div class="grid-item grid-item-2">
                            <input type="text" id="fppayment" name="fppayment"  required placeholder="Enter the Payment Amount" value="<?php echo ($rows['amount']/2)*0.018; ?>">
                            <input type="hidden" id="amount" name="amount" value="<?php echo $rows['amount']; ?>">
                            <i class="ri-wallet-3-fill"></i>
                        </div>
                    </div>
