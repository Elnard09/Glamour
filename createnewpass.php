...
if(isset($_GET['email']) && isset($_GET['reset_token']))
{
    ...
    $date = date("y-m-d");
    $query = "SELECT * FROM users WHERE email = '$_GET[email]' AND reset_token = '$_GET[reset_token]' AND token_expired = '$date' ";
...
if(isset($_POST['updatepass']))
{
    ...
    $update = "UPDATE `users` SET `password`='$hashed_password', `reset_token` = NULL, `token_expired` = NULL WHERE `email`='$email' ";
